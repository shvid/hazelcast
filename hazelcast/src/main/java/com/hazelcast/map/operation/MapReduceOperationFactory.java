...
public class MapReduceOperationFactory<KeyIn, ValueIn, KeyOut, ValueOut> implements OperationFactory {
	...
	public MapReduceOperationFactory(String name, Mapper<KeyIn, ValueIn, KeyOut, ValueOut> mapper, Reducer<KeyOut, ValueOut> reducer) {
		this.name = name;
		this.mapper = mapper;
